        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white p-10 rounded shadow-sm border border-gray-100">
              <span className="material-symbols-outlined text-4xl text-brand-blue-500 mb-6">diamond</span>
            ...
            <div className="bg-white p-10 rounded shadow-sm border border-gray-100">
              <span className="material-symbols-outlined text-4xl text-brand-blue-500 mb-6">public</span>
            ...
            <div className="bg-white p-10 rounded shadow-sm border border-gray-100">
              <span className="material-symbols-outlined text-4xl text-brand-blue-500 mb-6">lock</span>
