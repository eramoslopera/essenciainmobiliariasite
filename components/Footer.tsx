      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-gray-500">
          ...
          <div className="flex gap-4">
            {/* Instagram */}
            <a href="https://www.instagram.com/essencia_inmobiliaria/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 bg-white/10 flex items-center justify-center hover:bg-white hover:text-brand-blue-600 transition-colors text-white rounded-full hover:shadow-diffusion focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/essenciainmobiliariagandia" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 bg-white/10 flex items-center justify-center hover:bg-white hover:text-brand-blue-600 transition-colors text-white rounded-full hover:shadow-diffusion focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/santi-torres-essencia-a9497311/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-8 h-8 bg-white/10 flex items-center justify-center hover:bg-white hover:text-brand-blue-600 transition-colors text-white rounded-full hover:shadow-diffusion focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
